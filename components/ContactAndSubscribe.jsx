...
const ContactAndSubscribe = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center gap-8 bg-blue-50 p-4 lg:p-8 min-h-screen max-w-6xl mx-auto">
      {/* Contact Section */}
      ...
      <div className="bg-white p-4 lg:p-8 rounded-2xl shadow-xl w-full lg:max-w-2xl h-auto lg:h-[60vh] flex flex-col justify-center items-center text-center mt-0">
       ...
       <form className="flex mt-6 lg:mt-10 flex-col lg:flex-row items-center w-full space-y-4 lg:space-y-0 lg:space-x-4">
         ...
         />
         <button className="w-full lg:w-auto bg-red-600 px-6 py-4 text-white font-bold rounded-lg hover:bg-black transition-colors duration-600">
           Subscribe
         </button>
       </form>
